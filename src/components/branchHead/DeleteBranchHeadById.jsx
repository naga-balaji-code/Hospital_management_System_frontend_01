...
const DeleteBranchHeadById = () => {
  ...
  const handleDelete = async () => {
    if (!branchHeadId || isNaN(branchHeadId)) {
      toast.error("Please enter a valid Branch Head ID");
      return;
    }
    ...
    try {
      ...
      toast.error("Error deleting Branch Head. Please check the ID.");
    }
  };
...
export default DeleteBranchHeadById;